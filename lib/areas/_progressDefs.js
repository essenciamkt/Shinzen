...
const PROGRESS_DEFS = {
  ...
  mente: {
    badges: [
      ...
      { id: 'journal-30', nome: 'Escritor',      icone: '📓', desc: '30 dias de journal.',
        check: c => histCount(c.historico, 'journalHoje', v => v >= 1) >= 30, meta: 30,
        atualFn: c => histCount(c.historico, 'journalHoje', v => v >= 1) },
    ...
    missoes: [
      ...
      { id: 'journal',  nome: 'Escrever no journal',   icone: '📓', periodo: 'dia', xp: 1,
        check: c => Number(c.campos.journalHoje) >= 1 },
    ],
  },
};
