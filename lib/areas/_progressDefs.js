  ...
  metas: (() => {
    ...
    return {
      badges: [
        ...
        { id: 'sair-casa', nome: 'Livre', icone: '🚪', desc: 'Saiu de casa.',
          check: c => done(c, 'goal-sair-casa') },
        { id: 'nomade', nome: 'Nômade', icone: '🧳', desc: 'Vida de Airbnb em Airbnb.',
          check: c => done(c, 'goal-airbnb') },
        { id: 'tio-sam', nome: 'Terra do Tio Sam', icone: '🇺🇸', desc: 'Pisou nos EUA.',
          check: c => done(c, 'goal-eua') },
        { id: 'porsche-garagem', nome: 'Porsche na Garagem', icone: '🏎️', desc: 'Comprou o Porsche.',
          check: c => done(c, 'goal-porsche') },
        { id: 'achou-sofia', nome: 'Encontrou a Sofia', icone: '❤️', desc: 'A meta mais importante.',
          check: c => done(c, 'goal-sofia') },
        { id: 'tanquinho', nome: 'Tanquinho', icone: '🏋️', desc: 'Abdômen definido.',
          check: c => done(c, 'goal-abdomen') },
        { id: 'monstro', nome: 'Monstro', icone: '💪', desc: 'Corpo musculoso.',
          check: c => done(c, 'goal-musculoso') },
        { id: 'poliglota', nome: 'Poliglota', icone: '🗣️', desc: 'Espanhol e inglês fluentes.',
          check: c => done(c, 'goal-espanhol') && done(c, 'goal-ingles') },
        { id: 'dez-mil-mes', nome: 'R$10k/mês', icone: '💸', desc: 'Primeiro mês de 5 dígitos.',
          check: c => done(c, 'goal-renda-0') },
        { id: 'primeiro-milhao', nome: 'Primeiro Milhão', icone: '🏦', desc: 'R$1M de patrimônio.',
          check: c => done(c, 'goal-patr-5') },
