...
/* Área "Mente & Hábitos" — UM trabalho: regulação emocional sob pressão
   ...
   reset de 2min. "& Hábitos" = hábitos mentais (gratidão/respirei).
   ...
   Escrita livre (journal) virou área própria: Diário (lib/areas/diario.js).

   score:
   - 50% ansiedade invertida (1=calmo=100, 10=0)
   - 30% humor (humor*10)
   - 20% hábitos mentais (gratidão hoje)
*/
...
function calcScore(campos) {
  ...
  // hábitos mentais (gratidão de hoje)
  const habs = ['gratidaoHoje'];
