...
// Seed v4: objetivos datados do Emanuel, em 8 categorias (track). Datas
// acordadas (agressivas). Porsche carrega as 10 missões do caminho.
function seedMetasGoals() {
  ...
  renda.forEach(([t, v, p], i) => goals.push(g('goal-renda-' + i, t, '💸', 'renda', 'mrr', v, p)));

  // ── Financeiro: Patrimônio / caixa ──
  ...
  patr.forEach(([t, v, p], i) => goals.push(g('goal-patr-' + i, t, '🏦', 'patrimonio', 'savings', v, p)));

  // ── Corpo ──
  goals.push(g('goal-abdomen', 'Abdômen visível', '🔥', 'corpo', null, 0, '2026-09-20'));
  goals.push(g('goal-shape', 'Shape que chama atenção na sala', '💪', 'corpo', null, 0, '2027-02-15'));
  goals.push(g('goal-condicionamento', 'Excelente condicionamento', '🏃', 'corpo', null, 0, '2027-05-03'));

  // ── Idiomas ──
  goals.push(g('goal-ingles', 'Conversa natural em inglês', '🇺🇸', 'idioma', null, 0, '2026-10-01'));
  goals.push(g('goal-espanhol', 'Fluente em espanhol', '🇪🇸', 'idioma', null, 0, '2027-01-18'));

  // ── Mentalidade ──
  goals.push(g('goal-100dias', '100 dias seguidos sem abandonar a execução', '🔁', 'mentalidade', null, 0, '2026-09-27'));
  goals.push(g('goal-vender-olhos', 'Vender olhando nos olhos sem medo', '👁️', 'mentalidade', null, 0, '2026-07-31'));
  goals.push(g('goal-venda-10k', 'Fechar uma venda de R$10 mil sozinho', '🤝', 'mentalidade', null, 0, '2026-12-13'));
  goals.push(g('goal-venda-100k', 'Fechar uma venda de R$100 mil', '💼', 'mentalidade', null, 0, '2027-11-08'));

  // ── Liderança ──
  goals.push(g('goal-1a-pessoa', 'Primeira pessoa trabalhando comigo', '🧑‍🤝‍🧑', 'lideranca', null, 0, '2026-08-21'));
  goals.push(g('goal-time', 'Primeiro pequeno time', '👥', 'lideranca', null, 0, '2027-03-11'));
  goals.push(g('goal-empresa-roda', 'Empresa roda sem depender de mim', '🏢', 'lideranca', null, 0, '2027-12-09'));

  // ── Experiências ──
  goals.push(g('goal-1o-mes-renda', '1º mês vivendo 100% da própria renda', '💵', 'experiencias', null, 0, '2026-08-31'));
  goals.push(g('goal-morar-sozinho', '1ª temporada morando sozinho', '🏠', 'experiencias', null, 0, '2026-10-03'));
  goals.push(g('goal-viagem-intl', 'Primeira viagem internacional', '✈️', 'experiencias', null, 0, '2026-12-18'));
  ...
  // ── Sofia ──
  goals.push(g('goal-sofia-contato', 'Primeiro contato significativo', '💬', 'sofia', null, 0, '2026-09-15', { porque: 'Ou fortalecer o contato, se já existir.' }));
  goals.push(g('goal-sofia-condicoes', 'Em condições reais de viajar até ela', '🧭', 'sofia', null, 0, '2027-03-20', { porque: 'Sem colocar a vida financeira em risco.' }));
  goals.push(g('goal-sofia-encontro', 'Encontro presencial', '❤️', 'sofia', null, 0, '2027-06-12', { estrela: true, porque: 'O encontro que move tudo.' }));
